 ...
 * Report Controller
 *
 * Controls requesting and creation of visualisation reports, for non-API routes
 * data requested from the database
 * Data generated from altmetrics data collection API wrapper (nodealm), then and inserted into the database
 */
...
var ReportController = BaseController.extend({
	...
	/**
	 * Creates new report by fetching from nodealm and returns visualisation to user
	 * @param  {Obj}      req  Request obj
	 * @param  {Obj}      res  Response obj
